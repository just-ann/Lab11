...
public CCircle(Graphics graphics, int X, int Y)
        ...
        {
            Rectangle rectangle1 = new Rectangle((int)(X - Radius*1.4), Y - Radius, 2 * Radius, 2 * Radius);
            Rectangle rectangle2 = new Rectangle((int)(X - Radius / 2.488), (int)(Y - Radius * 7.899), 2 * Radius, 2 * Radius);
